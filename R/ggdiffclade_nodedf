...
ggdiffclad_nodedf <- function(sub_physeq = NULL, classgroup = NULL, mlfun = "lda", ldascore = 3,
  ...
  ggdiffclad_nodedf <- diff_analysis(sub_physeq = sub_physeq,
